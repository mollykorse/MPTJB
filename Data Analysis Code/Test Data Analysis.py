...
file_path = 'c:/Systemvetenskap/Python/Molkor First Fork/MPTJB/Dataset Job Listings/2023.enriched.jsonl'

# Keywords that might indicate a listing is related to IT
it_keywords = ["software", "IT", "developer", "technology", "programming", "computer", "data"]
...
# Open the .jsonl file and iterate through each object
with jsonlines.open(file_path) as reader:
    for obj in tqdm(reader, desc="Collecting IT-related descriptions"):
...
if len(it_descriptions) >= 2:
    ...
    print("Less than 2 IT-related descriptions available.")
